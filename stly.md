...
- Use the same top menu on the catalog and every game page: Catalog, Tic-tac-toe, Snake, Pong, Breakout, Minesweeper, Space Invaders, 15 Puzzle, Memory Match, Simon, Frogger, Hangman, Asteroids, Tetris, Whac-A-Mole, Lunar Lander, Connect Four, Centipede, Kaboom!
...
- Connect Four, Centipede, and Kaboom! use the same compact board/status/button pattern as the other catalog games and keep keyboard/touch controls inside the shared shell.
