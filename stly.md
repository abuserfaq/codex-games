...
- Use the same top menu on the catalog and every game page: Catalog, Tic-tac-toe, Snake, Pong, Breakout, Minesweeper, Space Invaders, 15 Puzzle, Memory Match, Simon, Frogger, Hangman, Asteroids.
