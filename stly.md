...
- Pac-Man, Missile Command, Sokoban, Reversi, Qix Claim, Lights Out, Mastermind, Pipe Dream, SameGame, Nim Sticks, Peg Solitaire, and Battleship Radar use generated SVG assets while keeping the same compact board/status/button pattern as the other catalog games.
